...
export default function DashboardLayout({
    ...
    return (
        <div className="flex min-h-screen bg-gray-50 font-sans selection:bg-blue-500 selection:text-white">
            
            {/* Sidebar */}
            <aside className="w-64 bg-gradient-to-b from-blue-700 to-indigo-900 text-white flex flex-col shrink-0 shadow-xl">
                
                {/* Brand Logo */}
                <div className="h-16 flex items-center justify-center border-b border-blue-600/30 px-6 gap-3">
                    <svg className="h-8 w-8 text-white rotate-[-15deg]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span className="font-extrabold text-lg tracking-wider">SB ADMIN <sup className="text-xs font-normal opacity-80">2</sup></span>
                </div>
                ...
                <nav className="flex-1 px-4 py-6 space-y-2">
                    ...
                    <div className="border-t border-white/10 my-4 pt-4">
                        <span className="px-4 text-[10px] uppercase font-bold tracking-wider text-white/50 block mb-2">Interface CMS</span>
                    </div>
                    ...
                    <div className="border-t border-white/10 my-4 pt-4">
                        <span className="px-4 text-[10px] uppercase font-bold tracking-wider text-white/50 block mb-2">Account</span>
                    </div>
                ...
                {/* Sidebar Footer */}
                <div className="p-4 border-t border-blue-600/30 text-center text-xs text-white/50">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-sm z-20">
                    ...
                    {/* <div className="hidden sm:flex items-center bg-gray-100 rounded-lg overflow-hidden border border-gray-200 w-80">
                        ...
                        />
                        <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 transition shrink-0">
                    ...
                    <div className="flex items-center gap-6 ml-auto">
                        ...
                        <div className="relative">
                            ...
                            >
                                <span className="text-sm font-semibold hidden md:inline group-hover:text-blue-600 transition">{fullname}</span>
                                <div className="h-10 w-10 rounded-full bg-blue-100 border border-blue-200 flex items-center justify-center text-blue-700 font-bold text-sm overflow-hidden">
