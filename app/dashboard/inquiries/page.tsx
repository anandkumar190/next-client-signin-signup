        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                    <h6 className="font-bold text-gray-900 text-sm">Messages Box</h6>
                    <span className="bg-gray-900 text-white text-[10px] font-extrabold px-2.5 py-1 rounded-full uppercase tracking-wider">
                        ...
                        inquiries.map(inq => (
                            <div 
                                ...
                                className={`p-6 transition flex flex-col md:flex-row gap-4 items-start justify-between ${
                                    inq.isRead ? "bg-white opacity-80" : "bg-gray-50/40 font-semibold"
                                }`}
                            >
                                <div className="space-y-2 max-w-3xl">
                                    <div className="flex flex-wrap items-center gap-3">
                                        ...
                                        <a href={`mailto:${inq.email}`} className="text-xs text-gray-800 font-semibold hover:underline">{inq.email}</a>
                                        <span className="text-xs text-gray-400 font-normal">&bull;</span>
